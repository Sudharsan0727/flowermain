...
const HospitalContentManagement = () => {
    const API_URL = `${API_BASE}/api/hospital/content`;
    ...
    const fetchContent = async () => {
        try {
            ...
            console.error(err);
            setIsLoading(false);
            showNotification("Failed to load hospital content.", "error");
        }
    };
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            showNotification("Hospital content updated successfully!", "success");
        } catch (error) {
            console.error(error);
        ...
        <AdminLayout>
            <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 no-scrollbar pb-32">
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <h1 className="text-4xl font-black text-slate-900 font-serif mb-2 tracking-tight">Hospital Content</h1>
                        <p className="text-slate-500 font-medium">Manage the hero banner and introductory text for the Hospital Delivery page.</p>
                    </div>
                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="e.g. Healing & Wellness"
                                    />
                                </div>
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="e.g. Hospital Delivery"
                                    />
                                </div>
                            </div>
...
export default HospitalContentManagement;
