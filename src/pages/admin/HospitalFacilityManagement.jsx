...
const HospitalFacilityManagement = () => {
    const API_URL = `${API_BASE}/api/hospital/facilities`;
        ...
        <AdminLayout>
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 no-scrollbar pb-32">
                <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <h1 className="text-4xl font-black text-slate-900 font-serif mb-2 tracking-tight">Hospital Facilities</h1>
                        <p className="text-slate-500 font-medium">Manage the list of partnered medical centers and delivery areas.</p>
                    </div>
...
export default HospitalFacilityManagement;
