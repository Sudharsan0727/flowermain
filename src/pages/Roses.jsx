...
export default function Roses() {
  const [activeMainCollection, setActiveMainCollection] = useState('Roses');
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] font-sans text-slate-800">
      ...
      {/* ── Page Header ── */}
      <section className="relative bg-rose-50 py-16 md:py-24 overflow-hidden flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #fff1f2 0%, #ffe4e6 100%)' }}>
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-20%] right-[-10%] w-[400px] h-[400px] bg-rose-200/20 blur-[80px] rounded-full" />
        ...
        <div className="relative z-10 text-center space-y-4 px-6">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif text-slate-900 leading-tight tracking-tight capitalize">
            {activeMainCollection === 'All' ? 'Our Entire' : activeMainCollection.toLowerCase()} <span className="italic font-light text-brand-accent">Gallery</span>
          </h1>
          <p className="text-slate-500 max-w-xl mx-auto font-light md:text-lg">
            {activeMainCollection === 'All'
              ...
              : 'The ultimate symbol of love and beauty. Our master florists select the most exquisite stems from our private nurseries.'}
          </p>
        </div>
      </section>
